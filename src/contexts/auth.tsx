...
import { IAutheticate, IUserLogin } from "../services/data/User"
import { isAfter, parseISO } from "date-fns"
import { apiUser } from "../services/data"

export interface IAuthContextData{
    signIn(credentials: IAutheticate): Promise<void>
...
const AuthProvider = ({children}: IProvider) => {
    ...
    const signIn = useCallback(async({ email,password }: IAutheticate) => {
